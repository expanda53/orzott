...
public class BluetoothSerial2 extends CordovaPlugin {
    ...
    private BluetoothSerialService2 bluetoothSerialService2;
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        ...
        if (bluetoothSerialService2 == null) {
            bluetoothSerialService2 = new BluetoothSerialService2(mHandler);
        }
        ...
        if (action.equals(LIST)) {
            ...
            bluetoothSerialService2.write(data);
            callbackContext.success();
            ...
            if (bluetoothSerialService2.getState() == BluetoothSerialService2.STATE_CONNECTED) {
                callbackContext.success();
            } else {
    ...
    private void connect(CordovaArgs args, boolean secure, CallbackContext callbackContext) throws JSONException {
        ...
        if (device != null) {
            ...
            bluetoothSerialService2.connect(device, secure);
